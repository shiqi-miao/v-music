...
<template>
    <div class="app-container">
      <el-input placeholder="请输入内容" v-model="listQuery.userPhone" class="input-with-select">
      ...
      stripe max-height="1200">
        ...
        <el-table-column align="center" label="管理" width="200">
            <template slot-scope="scope">
              <span @click="orderdetails(scope.row.orderCode)" class="blue">查看</span>
            </template>
       </el-table-column>
      </el-table>
