        ...
        <div class="container">
            ...
            <div class="box">
                <div class="flex-center-Y line">
                    ...
                    <div class="flex-center-Y" style="margin-right:50px;cursor:pointer" @click="form.authType='company'">
                    ...
                    <div class="flex-center-Y" @click="form.authType='person'" style="cursor:pointer">
            ...
            <div class="flex-center-Y">
                <div class="btn1" @click="$router.go(-1)">取消创建</div>
...
export default {
    ...
    methods: {
        commit(){
            ...
            this.api({
                url: "/distribute/distributeManAdd",
                method: "post",
                data: commitData
            })
                .then(data => {
