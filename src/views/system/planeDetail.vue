    ...
    <div>
        <div class="" style="display:flex;display: -webkit-flex;">
            <div class="flex-2 left">
                ...
                <span v-if="SalePlanDetails.flag==false">计划应用时间: {{SalePlanDetails.gmtPlan}}</span>
                <span v-if="SalePlanDetails.flag==true">计划应用时间: </span>
                <el-date-picker
                    v-model="dateTime"
                    v-if="SalePlanDetails.flag==true"
                    type="date"
                    placeholder="选择日期"
                ...
                <!-- <el-date-picker
                    v-if="SalePlanDetails.flag==true"
                    v-model="SalePlanDetails.gmtPlan"
                    type="datetime"
                ...
                <br>
                <br>
                <el-button @click="save" type="primary" :disabled="!SalePlanDetails.flag">执行计划</el-button>
...
export default {
    ...
    methods: {
        ...
        getInfo(){
            this.api({
                ...
                .then(data => {
                   ...
                   this.dateTime=data.gmtPlan.split(" ")[0]
                   this.timeTime=data.gmtPlan.split(" ")[1]
        ...
        confirm() {
            console.log(this.dateTime,this.timeTime)
