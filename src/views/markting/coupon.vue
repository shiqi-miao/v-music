    ...
    <div class="app-container">
        <el-form>
            ...
            <el-input placeholder="请输入内容"
                ...
                <el-button slot="append"
                   ...
                   @click="toCreate">申请优惠券</el-button>
            </el-form-item>
        </el-form>
        <br><br>
        <el-table :data="tableData"
            ...
            <el-table-column prop="coverUser"
                ...
                <template slot-scope="scope">
                    <el-popover placement="top-start"
                                width="120"
                                trigger="hover">
                        <div v-for="(item,i) in scope.row.storeList"
                                :key="i">
                            {{item}}
                        </div>
            ...
            <el-table-column prop="reasonInfo"
                             ...
                             :key="Math.random()">
                <template slot-scope="scope">
                    {{scope.row.usedNum || 0}} / {{scope.row.couponNum}}
                </template>
            </el-table-column>
            <el-table-column prop="reasonInfo"
                             label="核销价值"
...
export default {
    ...
    methods: {
        ...
        toDetail(row){
                this.$router.push({
                    path:"/markting/detail/" +row.applyId
                })
        },
        toCreate() {
            this.$router.push({
                path: "/markting/create"
            });
        },
        addLine() {
