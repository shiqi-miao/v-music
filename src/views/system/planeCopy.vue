    ...
    <div>
        <div class="" style="display:flex;display: -webkit-flex;">
            <div class="flex-2 left">
                ...
                <br>
                <br>
                <el-button @click="save" type="primary" :disabled="!SalePlanDetails.flag">保存并执行</el-button>
...
export default {
    ...
    methods: {
        ...
        getVend(){
            ...
            let routeid=this.$route.params.oldId
        ...
        confirm() {
                ...
                this.SalePlanDetails.gmtPlan=dateTime+' '+this.timeTime
                this.api({
        ...
        save(){
            ...
            let dateTime=this.dateTime.getFullYear()+'-'+month+'-'+date
            // this.dateTime=dateTime
            this.time=dateTime+' '+this.timeTime
            if(!this.time){
                this.$message({
                        type: "error",
                        message: "请选择计划应用时间"
