    ...
    <div class="reg-container flex-center">
        ...
        <div class="content"
            ...
            <div class="center"
                ...
                <el-button type="primary"
                           round
                           @click="toIndex">进入机器列表</el-button>
            </div>
            <div class="center"
                 v-else>
                <el-button type="primary"
...
export default {
    ...
    methods: {
        ...
        active() {
            this.api({
                url: "/operator/findIsVendByCodeOperator",
                method: "post",
                data: {
        ...
        init() {
            ...
            this.api({
                url: "/operator/addAisleInfoByOperator",
                method: "post",
                data: {
        ...
        search() {
            ...
            this.api({
                url: "/operator/findVendInfoByOperator",
                method: "post",
                data: {
                    machineCode: this.machineCode
                }
