...
<template>
  <div id="mapDataScreen">
    <div class="map">
      ...
      <map-chart @showDetails='showDetails' zoom=6 needLogin=1 :location="location" ref="mychild"></map-chart>
       <dv-border-Box-1 class="machine">
          <div class="title">设备热销排行</div>
          <div class="dateRange">
              <el-radio-group v-model="dayNum" @change="changeMachineHot">
          ...
          <div class="table">
            <div class="thead flex-center-Y">
              ...
              <div class="tr flex-center-Y justify-center">
                  销量（件）
                  <div>
                    <div style="height:12px" @click="orderNum='0';orderType='asce';changeMachineHot"><img v-if="orderType=='asce' && orderNum=='0'" src="../../assets/screen/asce.png" alt=""><img v-else src="../../assets/screen/asce-1.png" alt=""></div>
                    <div style="height:12px" @click="orderNum='0';orderType='desc';changeMachineHot"><img v-if="orderType=='desc' && orderNum=='0'" src="../../assets/screen/desc.png" alt=""><img v-else src="../../assets/screen/desc-1.png" alt=""></div>
                  </div>
              </div>
              <div class="tr flex-center-Y justify-center">
                  利润（元）
                  <div>
                    <div style="height:12px" @click="orderNum='1';orderType='asce';changeMachineHot"><img v-if="orderType=='asce' && orderNum=='1'" src="../../assets/screen/asce.png" alt=""><img v-else src="../../assets/screen/asce-1.png" alt=""></div>
                    <div style="height:12px" @click="orderNum='1';orderType='desc';changeMachineHot"><img v-if="orderType=='desc' && orderNum=='1'" src="../../assets/screen/desc.png" alt=""><img v-else src="../../assets/screen/desc-1.png" alt=""></div>
                  </div>
              </div>
            </div>
            <div class="line"></div>
       ...
       <dv-border-Box-1 class="sku">
          ...
          <div class="dateRange">
              <el-radio-group v-model="dayNum1" @change="changeSkuHot">
                <el-radio-button label="1">今日</el-radio-button>
                <el-radio-button label="7">近7天</el-radio-button>
                <el-radio-button label="30">近30天</el-radio-button>
            </el-radio-group>
          ...
          <div class="table">
            <div class="thead flex-center-Y">
              ...
              <div class="tr flex-center-Y justify-center">
                  销量（件）
                  <div>
                    <div style="height:12px" @click="orderNum1='0';orderType1='asce';changeSkuHot"><img v-if="orderType1=='asce' && orderNum1=='0'" src="../../assets/screen/asce.png" alt=""><img v-else src="../../assets/screen/asce-1.png" alt=""></div>
                    <div style="height:12px" @click="orderNum1='0';orderType1='desc';changeSkuHot"><img v-if="orderType1=='desc' && orderNum1=='0'" src="../../assets/screen/desc.png" alt=""><img v-else src="../../assets/screen/desc-1.png" alt=""></div>
                  </div>
              </div>
              <div class="tr flex-center-Y justify-center">
                  利润（元）
                  <div>
                    <div style="height:12px" @click="orderNum1='1';orderType1='asce';changeSkuHot"><img v-if="orderType1=='asce' && orderNum1=='1'" src="../../assets/screen/asce.png" alt=""><img v-else src="../../assets/screen/asce-1.png" alt=""></div>
                    <div style="height:12px" @click="orderNum1='1';orderType1='desc';changeSkuHot"><img v-if="orderType1=='desc' && orderNum1=='1'" src="../../assets/screen/desc.png" alt=""><img v-else src="../../assets/screen/desc-1.png" alt=""></div>
                  </div>
              </div>
            </div>
            <div class="line"></div>
